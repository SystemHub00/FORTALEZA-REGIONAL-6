...
<head>
    ...
    <title>Fortaleza - Regional VI</title>
...
<body data-start-step="{{ current_step }}">
    ...
    <header class="main-header">
        <div class="header-logos">
            ...
            <img src="/static/logoprojeto.jpeg"    alt="Fortaleza Regional VI" class="logo-projeto-topo">
        </div>
    </header>
        ...
        <div class="wizard-shell">
            <form id="wizard-form" method="POST"
                ...
                <section class="wizard-panel" data-step="index">
                    <div class="hero-grid">
                        <div class="hero-card">
                            <span class="hero-pill">FORTALEZA - REGIONAL VI</span>
                            <p style="margin:10px 0 0; color:#8b0000; font-size:0.9rem; font-weight:700; line-height:1.5;">
                                CFIS - Centro de Formação e Inclusão Social Nossa Senhora de Fátima
                            </p>
                            ...
                            <div class="hero-highlights">
                                ...
                                <!-- Sobre o projeto -->
                                <div class="hero-highlight">
                                    <strong>FORTALEZA - REGIONAL VI</strong>
...
def confirmacao():
    ...
    if not protocolo:
        return redirect(url_for("home"))
    home_url = "https://fortaleza-regional-6.onrender.com"
    return render_template_string(
        TEMPLATE_CONFIRMACAO,
        protocolo          = protocolo,
